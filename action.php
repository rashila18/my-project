<!-- fetch data of categories from database -->
...
// get data from the table products
			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>NRs.$pro_price.00
...
// product add to cart
	...
	// fetch data from cart for checkout	
	...
	if($count > 0){
		...
		while($row=mysqli_fetch_array($run_query)){
			...
			if(isset($_POST["get_cart_product"])){
				...
				<div class='row'>
					...
					<div class='col-md-3 col-xs-3'>NRs.$pro_price.00</div>
				</div>
			";
			$no = $no + 1;
			}else{
		...
		echo '
				...
				<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
				  ...
				  <input type="hidden" name="business" value="merchant@Ecommstore.com">
				...
				echo   '
				<input type="hidden" name="return" value="https://Ecommstore.000webhostapp.com/payment_success.php"/>
				<input type="hidden" name="cancel_return" value="http://www.sysc.esy.es/shoppingCart/cancel.php"/>
				<input type="hidden" name="currency_code" value="USD"/>
				<input type="hidden" name="custom" value="'.$uid.'"/>
				<input style="float:right;margin-right:0px;" type="image" name="submit"
					src="product_images/paypall.png" alt="PayPal Checkout"
